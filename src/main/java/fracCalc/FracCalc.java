...
public class FracCalc {
        ...
        public static void main(String[] args) {
               ...
               while (!equation.equals("quit")) {
                       ...
                       System.out.print("Welcome to Fraccalc! Enter equation: ");
        ...
        public static String produceAnswer(String input) {
               ...
               int space = input.indexOf(" "); // find index of first space

               String operand1 = input.substring(0, space); // substring of beginning to space before operator

               String operator = input.substring(space + 1, space + 2); // operator is always 1 (length)
